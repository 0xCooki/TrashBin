...
///
///         This contract is slightly modified for multi-chain purposes, the Hashes and Hashes DAO funcitons
///         have been removed entirely. Other core functions operate as normal.
contract TrashBinMultiChain0 is Ownable, IERC721Receiver, IERC1155Receiver, ReentrancyGuard, Pausable {
    ...
    function buy(uint256[] memory indexes) external payable whenNotPaused nonReentrant {
        require(
            msg.value >= (buyPrice * indexes.length),
    ...
    /// @notice This function allows the owner to remove an NFT for sale and send the NFT to the owner 
    ...
    function _withdrawETH() internal {
        ...
        (bool success, ) = (owner()).call{value: totalWithdrawAmount * 1 wei}("");
