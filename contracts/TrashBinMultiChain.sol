...
///         have been made redundant. Other core functions operate as normal.
contract TrashBinMultiChain is Ownable, IERC721Receiver, IERC1155Receiver, ReentrancyGuard, Pausable {
    ...
    constructor(address _owner) {
        ...
        hashes = IHashes(address(0));
        hashesDAO = IHashesDAO(address(0));
        buyPrice = 0.02e18 wei;
        sellPrice = 100 wei;
        standardHashDiscount = 0;
        daoHashDiscount = 0;
        buyableDelay = 20000;
        minEthBalance = 0.001e18 wei;
        maxEthBalance = 0.1e18 wei;
        ethPercentageToOwner = 10000;
    }
